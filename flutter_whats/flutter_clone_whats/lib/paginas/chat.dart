...
class _ChatPaginaState extends State<ChatPagina> {
  ...
  Widget getAppBar(){
    ...
    return AppBar(
      backgroundColor: bgColor,
      leading: IconButton(onPressed: null,icon: Text("Editar",style:TextStyle(fontSize: 16,color: primary,fontWeight: FontWeight.w500)),
      ),
      actions: [IconButton(onPressed: null, icon: Icon(Icons.edit,color: primary,))],
    );
  }
  Widget getBody(){
      return ListView();
